...
## arm
load(paste0(inDir, "armrangerPeaksGR_REC8_MYC_Rep1_minuslog10_p0.05_q0.05_qval_sorted_noMinWidth.RData"))
armrangerPeaksGR <- armrangerPeaksGR[width(armrangerPeaksGR) <= 2000]
seqlevels(armrangerPeaksGR) <- sub("Chr", "", seqlevels(armrangerPeaksGR))
armrangerPeaksGR_200bp <- locMidpointFlank(armrangerPeaksGR, leftFlank = 99, rightFlank = 100)
...
## peri
load(paste0(inDir, "perirangerPeaksGR_REC8_MYC_Rep1_minuslog10_p0.05_q0.05_qval_sorted_noMinWidth.RData"))
perirangerPeaksGR <- perirangerPeaksGR[width(perirangerPeaksGR) <= 2000]
seqlevels(perirangerPeaksGR) <- sub("Chr", "", seqlevels(perirangerPeaksGR))
perirangerPeaksGR_200bp <- locMidpointFlank(perirangerPeaksGR, leftFlank = 99, rightFlank = 100)
