...
outDir <- "/home/meiosis/ajt200/analysis/170920_Chris_ChIP_REC8_histone/fastq_pooled/REC8/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.05_q0.05/REC8_HA_Rep1_peak_profiles/motifs/weeder2_bg_armranLoc_200bpseq/distribution/matchPWM_genome/"
plotDir <- "/home/meiosis/ajt200/analysis/170920_Chris_ChIP_REC8_histone/fastq_pooled/REC8/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.05_q0.05/REC8_HA_Rep1_peak_profiles/motifs/weeder2_bg_armranLoc_200bpseq/distribution/matchPWM_genome/plots/proportion/"
...
foreach(x = 1:num_pwm) %dopar% {
  ...
  pdf(paste0(plotDir, "REC8_HA_Rep1_peak_motif", x, "_", paste0(strsplit(consensusString(tmp), split = "")[[1]][21:(21+mean(width(motif.GRanges))-1)], collapse = ""), "_base_proportions.pdf"))
  par(mgp = c(2, 1, 0))
  barplot(prm_AGTC,
          col = c("green", "yellow", "red", "blue"),
          xlab = paste0("Position within REC8-HA Rep1 peak motif", x, "_", paste0(strsplit(consensusString(tmp), split = "")[[1]][21:(21+mean(width(motif.GRanges))-1)], collapse = ""), " matches and 20-bp flanks"),
          ylab = "Proportion",
          legend.text = TRUE,
          args.legend = list(
          x = ncol(prm_AGTC) + 16,
