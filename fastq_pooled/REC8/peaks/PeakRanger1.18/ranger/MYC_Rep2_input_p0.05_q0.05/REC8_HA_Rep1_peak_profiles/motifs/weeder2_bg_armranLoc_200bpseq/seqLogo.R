...
inDir <- "/home/meiosis/ajt200/analysis/170920_Chris_ChIP_REC8_histone/fastq_pooled/REC8/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.05_q0.05/REC8_HA_Rep1_peak_profiles/motifs/weeder2_bg_armranLoc_200bpseq/"
...
pdf(file = paste0(inDir, "REC8_HA_Rep1_peak_motifs_weeder2_bg_armranLoc_200bpseq.pdf"))
for(i in 1:num_pwm) {
  seqLogo(pwm_list[[i]])
}
dev.off()
